...
#ifndef BRPC_POLICY_SOFA_BOLT_PROTOCOL_H
#define BRPC_POLICY_SOFA_BOLT_PROTOCOL_H
...
void ProcessSofaBoltResponse(InputMessageBase* msg);
...
void PackSofaBoltRequest(butil::IOBuf* buf,
                         SocketMessage**,
